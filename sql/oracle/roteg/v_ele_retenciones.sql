CREATE OR REPLACE FORCE VIEW V_ELE_RETENCIONES ("ID", "ID_CONTRIBUYENTE", "CODIGO", "NUMERO", "CODIGO_DOCUMENTO", "ESTABLECIMIENTO", "PUNTO_EMISION", "SECUENCIAL", "FECHA", "TIPO_DOCUMENTO", "DOCUMENTO", "RAZON_SOCIAL", "PERIODO_FISCAL", "DIRECCION_ESTABLECIMIENTO") AS
