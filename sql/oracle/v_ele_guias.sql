CREATE OR REPLACE FORCE VIEW V_ELE_GUIAS ("ID", "ID_CONTRIBUYENTE", "CODIGO", "NUMERO", "CODIGO_DOCUMENTO", "ESTABLECIMIENTO", "PUNTO_EMISION", "SECUENCIAL", "FECHA", "DIRECCION_PARTIDA", "RAZON_SOCIAL_TRANSPORTISTA", "TIPO_DOCUMENTO", "DOCUMENTO", "PLACA") AS
